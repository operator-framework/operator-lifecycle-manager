...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/operator-framework/operator-lifecycle-manager/pkg/mock-ext-server/apis/anything/v1alpha1.Anything": schema_mock_ext_server_apis_anything_v1alpha1_Anything(ref),
...
func schema_mock_ext_server_apis_anything_v1alpha1_Anything(ref common.ReferenceCallback) common.OpenAPIDefinition {
