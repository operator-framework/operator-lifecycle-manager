...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersion":       schema_available_csvs_apis_available_v1alpha1_AvailableClusterServiceVersion(ref),
		"github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersionList":   schema_available_csvs_apis_available_v1alpha1_AvailableClusterServiceVersionList(ref),
		"github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersionSpec":   schema_available_csvs_apis_available_v1alpha1_AvailableClusterServiceVersionSpec(ref),
		"github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersionStatus": schema_available_csvs_apis_available_v1alpha1_AvailableClusterServiceVersionStatus(ref),
...
func schema_available_csvs_apis_available_v1alpha1_AvailableClusterServiceVersion(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AvailableClusterServiceVersion indicates that an operator (CSV) of the same spec is available for use in this ns.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersionSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersionStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersionSpec", "github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersionStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_available_csvs_apis_available_v1alpha1_AvailableClusterServiceVersionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AvailableClusterServiceVersionList is a list of AvailableClusterServiceVersion objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersion"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/operator-framework/operator-lifecycle-manager/pkg/available-csvs/apis/available/v1alpha1.AvailableClusterServiceVersion", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_available_csvs_apis_available_v1alpha1_AvailableClusterServiceVersionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AvailableClusterServiceVersionSpec matches the spec of the csv",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"install": {
						SchemaProps: spec.SchemaProps{
...
func schema_available_csvs_apis_available_v1alpha1_AvailableClusterServiceVersionStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AvailableClusterServiceVersionStatus matches the status of the csv",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
