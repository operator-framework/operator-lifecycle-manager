...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*BundleJob)(nil), (*operators.BundleJob)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_BundleJob_To_operators_BundleJob(a.(*BundleJob), b.(*operators.BundleJob), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*operators.BundleJob)(nil), (*BundleJob)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_operators_BundleJob_To_v1alpha1_BundleJob(a.(*operators.BundleJob), b.(*BundleJob), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*Poll)(nil), (*operators.Poll)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Poll_To_operators_Poll(a.(*Poll), b.(*operators.Poll), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*operators.Poll)(nil), (*Poll)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_operators_Poll_To_v1alpha1_Poll(a.(*operators.Poll), b.(*Poll), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_BundleJob_To_operators_BundleJob(in *BundleJob, out *operators.BundleJob, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	out.Condition = v1.JobConditionType(in.Condition)
	out.CompletionTime = (*metav1.Time)(unsafe.Pointer(in.CompletionTime))
	return nil
}

// Convert_v1alpha1_BundleJob_To_operators_BundleJob is an autogenerated conversion function.
func Convert_v1alpha1_BundleJob_To_operators_BundleJob(in *BundleJob, out *operators.BundleJob, s conversion.Scope) error {
	return autoConvert_v1alpha1_BundleJob_To_operators_BundleJob(in, out, s)
}

func autoConvert_operators_BundleJob_To_v1alpha1_BundleJob(in *operators.BundleJob, out *BundleJob, s conversion.Scope) error {
	out.Name = in.Name
	out.Namespace = in.Namespace
	out.Condition = v1.JobConditionType(in.Condition)
	out.CompletionTime = (*metav1.Time)(unsafe.Pointer(in.CompletionTime))
...
// Convert_operators_BundleJob_To_v1alpha1_BundleJob is an autogenerated conversion function.
func Convert_operators_BundleJob_To_v1alpha1_BundleJob(in *operators.BundleJob, out *BundleJob, s conversion.Scope) error {
	return autoConvert_operators_BundleJob_To_v1alpha1_BundleJob(in, out, s)
}
...
func autoConvert_v1alpha1_BundleLookup_To_operators_BundleLookup(in *BundleLookup, out *operators.BundleLookup, s conversion.Scope) error {
	out.BundleJob = (*operators.BundleJob)(unsafe.Pointer(in.BundleJob))
	out.ConfigMapRef = (*operators.ConfigMapResourceReference)(unsafe.Pointer(in.ConfigMapRef))
	out.Image = in.Image
	out.CatalogName = in.CatalogName
	out.CatalogNamespace = in.CatalogNamespace
...
func autoConvert_operators_BundleLookup_To_v1alpha1_BundleLookup(in *operators.BundleLookup, out *BundleLookup, s conversion.Scope) error {
	out.BundleJob = (*BundleJob)(unsafe.Pointer(in.BundleJob))
	out.ConfigMapRef = (*ConfigMapResourceReference)(unsafe.Pointer(in.ConfigMapRef))
	out.Image = in.Image
	out.CatalogName = in.CatalogName
	out.CatalogNamespace = in.CatalogNamespace
	out.Replaces = in.Replaces
...
func autoConvert_v1alpha1_CatalogSourceStatus_To_operators_CatalogSourceStatus(in *CatalogSourceStatus, out *operators.CatalogSourceStatus, s conversion.Scope) error {
	...
	out.LatestImageRegistryPoll = (*v1.Time)(unsafe.Pointer(in.LatestImageRegistryPoll))
...
func autoConvert_v1alpha1_InstallPlanList_To_operators_InstallPlanList(in *InstallPlanList, out *operators.InstallPlanList, s conversion.Scope) error {
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]operators.InstallPlan, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_InstallPlan_To_operators_InstallPlan(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_operators_InstallPlanList_To_v1alpha1_InstallPlanList(in *operators.InstallPlanList, out *InstallPlanList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]InstallPlan, len(*in))
		for i := range *in {
			if err := Convert_operators_InstallPlan_To_v1alpha1_InstallPlan(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1alpha1_Poll_To_operators_Poll(in *Poll, out *operators.Poll, s conversion.Scope) error {
	out.Interval = in.Interval
	return nil
}

// Convert_v1alpha1_Poll_To_operators_Poll is an autogenerated conversion function.
func Convert_v1alpha1_Poll_To_operators_Poll(in *Poll, out *operators.Poll, s conversion.Scope) error {
	return autoConvert_v1alpha1_Poll_To_operators_Poll(in, out, s)
}

func autoConvert_operators_Poll_To_v1alpha1_Poll(in *operators.Poll, out *Poll, s conversion.Scope) error {
	out.Interval = in.Interval
	return nil
}

// Convert_operators_Poll_To_v1alpha1_Poll is an autogenerated conversion function.
func Convert_operators_Poll_To_v1alpha1_Poll(in *operators.Poll, out *Poll, s conversion.Scope) error {
	return autoConvert_operators_Poll_To_v1alpha1_Poll(in, out, s)
}
