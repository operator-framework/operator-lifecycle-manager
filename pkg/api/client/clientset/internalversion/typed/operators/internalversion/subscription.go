...
type SubscriptionInterface interface {
	Create(ctx context.Context, subscription *operators.Subscription, opts v1.CreateOptions) (*operators.Subscription, error)
	Update(ctx context.Context, subscription *operators.Subscription, opts v1.UpdateOptions) (*operators.Subscription, error)
	UpdateStatus(ctx context.Context, subscription *operators.Subscription, opts v1.UpdateOptions) (*operators.Subscription, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*operators.Subscription, error)
	List(ctx context.Context, opts v1.ListOptions) (*operators.SubscriptionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *operators.Subscription, err error)
...
func (c *subscriptions) Get(ctx context.Context, name string, options v1.GetOptions) (result *operators.Subscription, err error) {
...
func (c *subscriptions) List(ctx context.Context, opts v1.ListOptions) (result *operators.SubscriptionList, err error) {
...
func (c *subscriptions) Create(ctx context.Context, subscription *operators.Subscription, opts v1.CreateOptions) (result *operators.Subscription, err error) {
	result = &operators.Subscription{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("subscriptions").
...
func (c *subscriptions) Update(ctx context.Context, subscription *operators.Subscription, opts v1.UpdateOptions) (result *operators.Subscription, err error) {
	result = &operators.Subscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subscriptions").
...
func (c *subscriptions) UpdateStatus(ctx context.Context, subscription *operators.Subscription, opts v1.UpdateOptions) (result *operators.Subscription, err error) {
	result = &operators.Subscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subscriptions").
...
func (c *subscriptions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *operators.Subscription, err error) {
	result = &operators.Subscription{}
