...
type OperatorGroupInterface interface {
	Create(*v1alpha2.OperatorGroup) (*v1alpha2.OperatorGroup, error)
	Update(*v1alpha2.OperatorGroup) (*v1alpha2.OperatorGroup, error)
	UpdateStatus(*v1alpha2.OperatorGroup) (*v1alpha2.OperatorGroup, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.OperatorGroup, error)
	List(opts v1.ListOptions) (*v1alpha2.OperatorGroupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.OperatorGroup, err error)
...
func (c *operatorGroups) Get(name string, options v1.GetOptions) (result *v1alpha2.OperatorGroup, err error) {
...
func (c *operatorGroups) List(opts v1.ListOptions) (result *v1alpha2.OperatorGroupList, err error) {
...
func (c *operatorGroups) Create(operatorGroup *v1alpha2.OperatorGroup) (result *v1alpha2.OperatorGroup, err error) {
	result = &v1alpha2.OperatorGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("operatorgroups").
...
func (c *operatorGroups) Update(operatorGroup *v1alpha2.OperatorGroup) (result *v1alpha2.OperatorGroup, err error) {
	result = &v1alpha2.OperatorGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("operatorgroups").
...
func (c *operatorGroups) UpdateStatus(operatorGroup *v1alpha2.OperatorGroup) (result *v1alpha2.OperatorGroup, err error) {
	result = &v1alpha2.OperatorGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("operatorgroups").
...
func (c *operatorGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.OperatorGroup, err error) {
	result = &v1alpha2.OperatorGroup{}
