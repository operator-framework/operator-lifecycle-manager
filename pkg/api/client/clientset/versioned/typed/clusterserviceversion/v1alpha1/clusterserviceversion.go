...
import (
	...
	scheme "github.com/coreos-inc/alm/pkg/api/client/clientset/versioned/scheme"
...
func newClusterServiceVersions(c *ClusterserviceversionV1alpha1Client, namespace string) *clusterServiceVersions {
