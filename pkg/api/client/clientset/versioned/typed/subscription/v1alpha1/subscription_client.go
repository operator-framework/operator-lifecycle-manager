...
import (
	v1alpha1 "github.com/coreos-inc/alm/pkg/api/apis/subscription/v1alpha1"
...
// SubscriptionV1alpha1Client is used to interact with features provided by the subscription group.
...
func NewForConfig(c *rest.Config) (*SubscriptionV1alpha1Client, error) {
	...
	return &SubscriptionV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SubscriptionV1alpha1Client for the given config and
...
func New(c rest.Interface) *SubscriptionV1alpha1Client {
	return &SubscriptionV1alpha1Client{c}
}
