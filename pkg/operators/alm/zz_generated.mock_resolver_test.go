...
func (_m *MockStrategyResolverInterface) InstallerForStrategy(_param0 string, _param1 client.Interface, _param2 v1.ObjectMeta, _param3 v1.ObjectMeta) install.StrategyInstaller {
