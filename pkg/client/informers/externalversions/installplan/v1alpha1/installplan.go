...
import (
	installplan_v1alpha1 "github.com/coreos-inc/alm/pkg/apis/installplan/v1alpha1"
	...
	v1alpha1 "github.com/coreos-inc/alm/pkg/client/listers/installplan/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InstallplanV1alpha1().InstallPlans(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InstallplanV1alpha1().InstallPlans(namespace).Watch(options)
			},
		},
		&installplan_v1alpha1.InstallPlan{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *installPlanInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&installplan_v1alpha1.InstallPlan{}, f.defaultInformer)
}
