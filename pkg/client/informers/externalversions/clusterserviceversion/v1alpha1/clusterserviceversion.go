...
import (
	clusterserviceversion_v1alpha1 "github.com/coreos-inc/alm/pkg/apis/clusterserviceversion/v1alpha1"
	...
	v1alpha1 "github.com/coreos-inc/alm/pkg/client/listers/clusterserviceversion/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterserviceversionV1alpha1().ClusterServiceVersions(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterserviceversionV1alpha1().ClusterServiceVersions(namespace).Watch(options)
			},
		},
		&clusterserviceversion_v1alpha1.ClusterServiceVersion{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterServiceVersionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterserviceversion_v1alpha1.ClusterServiceVersion{}, f.defaultInformer)
}
