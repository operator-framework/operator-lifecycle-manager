...
import (
	catalogsource_v1alpha1 "github.com/coreos-inc/alm/pkg/apis/catalogsource/v1alpha1"
	...
	v1alpha1 "github.com/coreos-inc/alm/pkg/client/listers/catalogsource/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CatalogsourceV1alpha1().CatalogSources(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CatalogsourceV1alpha1().CatalogSources(namespace).Watch(options)
			},
		},
		&catalogsource_v1alpha1.CatalogSource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *catalogSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&catalogsource_v1alpha1.CatalogSource{}, f.defaultInformer)
}
