...
var subscriptionsResource = schema.GroupVersionResource{Group: "subscription", Version: "v1alpha1", Resource: "subscriptions"}

var subscriptionsKind = schema.GroupVersionKind{Group: "subscription", Version: "v1alpha1", Kind: "Subscription"}
