...
var catalogsourcesResource = schema.GroupVersionResource{Group: "catalogsource", Version: "v1alpha1", Resource: "catalogsources"}

var catalogsourcesKind = schema.GroupVersionKind{Group: "catalogsource", Version: "v1alpha1", Kind: "CatalogSource"}
