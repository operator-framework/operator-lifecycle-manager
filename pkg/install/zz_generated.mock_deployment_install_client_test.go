...
func (_m *MockInstallStrategyDeploymentInterface) FindAnyDeploymentsMatchingNames(depNames []string) ([]*v1beta10.Deployment, error) {
	ret := _m.ctrl.Call(_m, "FindAnyDeploymentsMatchingNames", depNames)
	ret0, _ := ret[0].([]*v1beta10.Deployment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockInstallStrategyDeploymentInterfaceRecorder) FindAnyDeploymentsMatchingNames(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FindAnyDeploymentsMatchingNames", arg0)
}
