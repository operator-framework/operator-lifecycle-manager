	...
	tests := []struct {
		...
		},
		{
			...
			existingExtObjs: []runtime.Object{
				...
				crdWithConditions("c2", "v1", v1beta1.ConditionTrue, v1beta1.ConditionTrue),
			},
			met: true,
			expectedRequirementStatuses: map[gvkn]v1alpha1.RequirementStatus{
				{"", "v1", "ServiceAccount", "sa"}: {
		...
		},
		{
			...
			existingObjs: nil,
			existingExtObjs: []runtime.Object{
				crdWithConditions("c1", "v2", v1beta1.ConditionTrue, v1beta1.ConditionFalse),
			},
			met: false,
			expectedRequirementStatuses: map[gvkn]v1alpha1.RequirementStatus{
				{"apiextensions.k8s.io", "v1beta1", "CustomResourceDefinition", "c1group"}: {
		...
		},
		{
			...
			existingObjs: nil,
			existingExtObjs: []runtime.Object{
				crdWithConditions("c1", "v2", v1beta1.ConditionFalse, v1beta1.ConditionFalse),
			},
			met: false,
			expectedRequirementStatuses: map[gvkn]v1alpha1.RequirementStatus{
				{"apiextensions.k8s.io", "v1beta1", "CustomResourceDefinition", "c1group"}: {
