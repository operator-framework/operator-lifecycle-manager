...
type PackageManifestInterface interface {
	Create(*operators.PackageManifest) (*operators.PackageManifest, error)
	Update(*operators.PackageManifest) (*operators.PackageManifest, error)
	UpdateStatus(*operators.PackageManifest) (*operators.PackageManifest, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*operators.PackageManifest, error)
	List(opts v1.ListOptions) (*operators.PackageManifestList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *operators.PackageManifest, err error)
...
func (c *packageManifests) Get(name string, options v1.GetOptions) (result *operators.PackageManifest, err error) {
...
func (c *packageManifests) List(opts v1.ListOptions) (result *operators.PackageManifestList, err error) {
...
func (c *packageManifests) Create(packageManifest *operators.PackageManifest) (result *operators.PackageManifest, err error) {
	result = &operators.PackageManifest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("packagemanifests").
...
func (c *packageManifests) Update(packageManifest *operators.PackageManifest) (result *operators.PackageManifest, err error) {
	result = &operators.PackageManifest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packagemanifests").
...
func (c *packageManifests) UpdateStatus(packageManifest *operators.PackageManifest) (result *operators.PackageManifest, err error) {
	result = &operators.PackageManifest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packagemanifests").
...
func (c *packageManifests) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *operators.PackageManifest, err error) {
	result = &operators.PackageManifest{}
