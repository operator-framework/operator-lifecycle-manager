				...
				Properties: map[string]spec.Schema{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1.Icon{}.OpenAPIModelName()),
									},
								},
							},
						},
					...
					"provider": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref(v1.AppLink{}.OpenAPIModelName()),
						},
					},
					"annotations": {
						VendorExtensible: spec.VendorExtensible{
...
func schema_package_server_apis_operators_v1_ChannelEntry(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1.Deprecation{}.OpenAPIModelName()},
	}
}
...
func schema_package_server_apis_operators_v1_PackageChannel(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"currentCSVDesc": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref(v1.CSVDescription{}.OpenAPIModelName()),
						},
					},
					"deprecation": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1.ChannelEntry{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1.CSVDescription{}.OpenAPIModelName(), v1.ChannelEntry{}.OpenAPIModelName(), v1.Deprecation{}.OpenAPIModelName()},
	}
}
...
func schema_package_server_apis_operators_v1_PackageManifest(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1.PackageManifestSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1.PackageManifestStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1.PackageManifestSpec{}.OpenAPIModelName(), v1.PackageManifestStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1.PackageChannel{}.OpenAPIModelName()),
									},
								},
							},
						},
