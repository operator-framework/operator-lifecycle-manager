...
import (
	...
	v1 "github.com/operator-framework/operator-lifecycle-manager/pkg/package-server/client/listers/packagemanifest/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PackagemanifestV1().PackageManifests(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PackagemanifestV1().PackageManifests(namespace).Watch(options)
			},
		},
		&packagemanifestv1.PackageManifest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *packageManifestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&packagemanifestv1.PackageManifest{}, f.defaultInformer)
}
