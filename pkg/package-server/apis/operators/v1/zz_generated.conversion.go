...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		Convert_v1_AppLink_To_operators_AppLink,
		Convert_operators_AppLink_To_v1_AppLink,
		Convert_v1_CSVDescription_To_operators_CSVDescription,
		Convert_operators_CSVDescription_To_v1_CSVDescription,
		Convert_v1_Icon_To_operators_Icon,
		Convert_operators_Icon_To_v1_Icon,
		Convert_v1_PackageChannel_To_operators_PackageChannel,
		Convert_operators_PackageChannel_To_v1_PackageChannel,
		Convert_v1_PackageManifest_To_operators_PackageManifest,
		Convert_operators_PackageManifest_To_v1_PackageManifest,
		Convert_v1_PackageManifestList_To_operators_PackageManifestList,
		Convert_operators_PackageManifestList_To_v1_PackageManifestList,
		Convert_v1_PackageManifestSpec_To_operators_PackageManifestSpec,
		Convert_operators_PackageManifestSpec_To_v1_PackageManifestSpec,
		Convert_v1_PackageManifestStatus_To_operators_PackageManifestStatus,
		Convert_operators_PackageManifestStatus_To_v1_PackageManifestStatus,
	)
}
