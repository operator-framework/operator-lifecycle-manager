...
func (c *Client) AtomicModifyCustomResource(apiGroup, version, namespace, resourceKind, resourceName string, f operatorclient.CustomResourceModifier, data interface{}) error {
...
func (c *Client) ListCustomResource(apiGroup, version, namespace, resourceKind string) (*operatorclient.CustomResourceList, error) {
	glog.V(4).Infof("LIST CUSTOM RESOURCE]: %s", resourceKind)

	var crList operatorclient.CustomResourceList
