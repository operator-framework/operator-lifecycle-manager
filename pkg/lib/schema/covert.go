...
// - externalDocs
// - example.
func NewStructural(s *v1beta1ext.JSONSchemaProps) (*Structural, error) {
	if s == nil {
		return nil, nil
	}
...
func newGenerics(s *v1beta1ext.JSONSchemaProps) (*Generic, error) {
	if s == nil {
		return nil, nil
	}
	g := &Generic{
...
func newValueValidation(s *v1beta1ext.JSONSchemaProps) (*ValueValidation, error) {
	if s == nil {
		return nil, nil
	}
...
func newNestedValueValidation(s *v1beta1ext.JSONSchemaProps) (*NestedValueValidation, error) {
	if s == nil {
		return nil, nil
	}
...
func newExtensions(s *v1beta1ext.JSONSchemaProps) (*Extensions, error) {
	if s == nil {
		return nil, nil
	}
...
func validateUnsupportedFields(s *v1beta1ext.JSONSchemaProps) error {
	if len(s.ID) > 0 {
