...
replace (
	...
	github.com/operator-framework/api => github.com/perdasilva/api v0.10.8-0.20220525092001-be5d0818f8ca // og_toggle branch from my repo - for testing should not be merged
)
