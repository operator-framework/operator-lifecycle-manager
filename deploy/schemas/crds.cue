									...
									spec: {
										...
										properties: {
											...
											deployments: {
												type: "array"
												items: {
													description: "StrategyDeploymentSpec contains the name and spec for the deployment ALM should create"
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				...
				properties: {
					...
					status: {
						description: "OperatorStatus describes the observed state of an operator and its components."
