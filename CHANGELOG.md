...
## [0.14.2](https://github.com/operator-framework/operator-lifecycle-manager/tree/0.14.2) (2020-02-13)

[Full Changelog](https://github.com/operator-framework/operator-lifecycle-manager/compare/0.14.1...0.14.2)

**Closed issues:**

- Cannot install operator as normal user \(cannot create operatorgroup\) [\#1286](https://github.com/operator-framework/operator-lifecycle-manager/issues/1286)
- We cannot install another CSV using a different channel  [\#1285](https://github.com/operator-framework/operator-lifecycle-manager/issues/1285)
- Not able to view resources via Openshift Admin console for a K8s Cluster on GCP [\#1275](https://github.com/operator-framework/operator-lifecycle-manager/issues/1275)
- After operator uninstall, operator group remains. [\#1262](https://github.com/operator-framework/operator-lifecycle-manager/issues/1262)
...
- \[Bug\] Cannot import a customresourcedefinition that has been exported via 'oc get -o yaml' [\#1259](https://github.com/operator-framework/operator-lifecycle-manager/issues/1259)
- configmap-registry-server readinessProbe is to small causing crashes [\#1238](https://github.com/operator-framework/operator-lifecycle-manager/issues/1238)
- New release for CVE in 0.13.0 [\#1213](https://github.com/operator-framework/operator-lifecycle-manager/issues/1213)

**Other changes:**

- mention OLMs features in the introduction [\#1282](https://github.com/operator-framework/operator-lifecycle-manager/pull/1282) ([dmesser](https://github.com/dmesser))
- Bump version to 0.14.2 [\#1278](https://github.com/operator-framework/operator-lifecycle-manager/pull/1278) ([kevinrizza](https://github.com/kevinrizza))
- Bug 1798135: Fix cases where an operator's ready channel may never close. [\#1277](https://github.com/operator-framework/operator-lifecycle-manager/pull/1277) ([benluddy](https://github.com/benluddy))
- fix: update existing robot credentials [\#1276](https://github.com/operator-framework/operator-lifecycle-manager/pull/1276) ([exdx](https://github.com/exdx))
- Bug 1797675: Refactoring rh-operator test directory [\#1274](https://github.com/operator-framework/operator-lifecycle-manager/pull/1274) ([Bowenislandsong](https://github.com/Bowenislandsong))
- Bug 1768819: Fix configmap registry server readiness probe timeouts [\#1268](https://github.com/operator-framework/operator-lifecycle-manager/pull/1268) ([kramvan1](https://github.com/kramvan1))
- Bug 1789920: Fix bad opgroup annotations [\#1267](https://github.com/operator-framework/operator-lifecycle-manager/pull/1267) ([ecordell](https://github.com/ecordell))
- Generate changelog for 0.14.0 and 0.14.1. [\#1266](https://github.com/operator-framework/operator-lifecycle-manager/pull/1266) ([benluddy](https://github.com/benluddy))
- Generate manifests for version 0.14.1. [\#1265](https://github.com/operator-framework/operator-lifecycle-manager/pull/1265) ([benluddy](https://github.com/benluddy))
- chore\(ci\): update owners [\#1261](https://github.com/operator-framework/operator-lifecycle-manager/pull/1261) ([njhale](https://github.com/njhale))
- Bug 1800625: fix: add internal registry for catalog polling e2e test [\#1257](https://github.com/operator-framework/operator-lifecycle-manager/pull/1257) ([exdx](https://github.com/exdx))
- Bug 1777144: packageserver update fails to adopt APIService [\#1171](https://github.com/operator-framework/operator-lifecycle-manager/pull/1171) ([exdx](https://github.com/exdx))
